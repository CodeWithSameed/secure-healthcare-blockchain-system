  ...
  <main id="main">
   ...
   <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
           ...
           <center>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">Hospital Login</h1>
                </center>
				<form action="HospitalLogin" method="post">
                <div class="br-8 mt-10 inline-flex">
                <label for="uid">HOSPITAL ID :</label>
                    <input type="text"
                       
                        placeholder="Enter Hospital ID" name="uid"> &nbsp;&nbsp;&nbsp;</div>
                        <br><br>
                        <label for="password">PASSWORD :</label>
                    <input type="password"
                        
                        placeholder="Enter Hospital Password" name="pwd">
                        </div>
                        <br>
                        <center>
                    <input type="submit"
                        class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0" placeholder="Login"/>
               <a href="HospitalRegister.jsp" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">New Hospital</a>
             </center>
                </form>
      </div>
    </section>
