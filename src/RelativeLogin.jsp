            ...
            <center>
                ...
                <div class="br-8 mt-10 inline-flex">
                  <label for="uid">ED ADMIN EMAIL ID:</label>
                    ...
                    <input type="submit"
                         placeholder="Login"/>
                 <a href="RelativeRegister.jsp" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">Emergency Doctors Admin Register</a>
