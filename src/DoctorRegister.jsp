     ...
     <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            ...
            <center>
				...
				<form action="DoctorRegister" method="post" onsubmit="return validateForm()">
                <div>
                <label for="name">DOCTOR Name :</label>
                    ...
                    <input type="text"
                        ...
                        placeholder="Enter Password" name="password" oninput="validatePasswordStrength(this)"> &nbsp;&nbsp;&nbsp;
                        ...
                        placeholder="Enter Mobile" name="mobile" oninput="validateMobileNumber(this)"> 
                        <br><br>
                        ...
                        placeholder="Enter Pincode" name="pincode"  oninput="validatePincode(this)"> 
                        <br><br>
                         <label for="DHighestDegree">DOCTOR HIGHEST DEGREE :</label>
                        <input type="text"
                        
                        placeholder="Enter Doctor Highest Degree" name="DHighestDegree"> 
                        <br><br>
                        <label for="DHighestDegree">DOCTOR SPECIALIZATION :</label>
                        <input type="text"
                       
                        placeholder="Enter Doctor Specialization" name="DSpecialization"> 
                        <br><br>
                           <label for="DExperience">DOCTOR EXPERIENCE :</label>
                        <input type="text"
                       
                        placeholder="Enter Doctor Experience" name="DExperience"> 
                        <br><br>
                        <label for="DRegistrationNumber">DOCTOR REGISTRATION NO :</label>
                        <input type="text"
                       
                        placeholder="Enter Doctor Registration Number" name="DRegistrationNumber"> 
                        <br><br>
                         <label for="DRegistrationNumber">DOCTOR MEDICAL COUNCIL COMPLETED :</label>
                        <input type="text"
