    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
         ...
         <li><a class="nav-link scrollto " href="RelativeHome.jsp">Home</a></li>
          <li><a class="nav-link scrollto" href="ViewPatientsList.jsp">View Patient's List</a></li>
          <li><a class="nav-link scrollto" href="ViewPFiles.jsp">View Patient's File</a></li>
    ...
    <!-- ======= Breadcrumbs Section ======= -->
     <!-- <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            ...
            <br><br> <br><br>
            <center>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">EMERGENCY ADMIN LOGIN </h1>
                </center>
				<form action="RelativeLogin" method="post">
                <div class="br-8 mt-10 inline-flex">
                  <label for="uid">ED ADMIN EMAIL ID:</label>
                    <input type="text"
                        ...
                        placeholder="Email Address" name="uid"> &nbsp;&nbsp;&nbsp;
                        <br><br>
                         <label for="Password">ED ADMIN PASSWORD:</label>
                    <input type="password"
                        class="input-lg half bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                 ...
                 <a href="RelativeRegister.jsp" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">New Relative</a>
