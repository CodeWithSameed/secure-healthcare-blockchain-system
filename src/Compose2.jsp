        ...
        <ul>
         <li><a class="nav-link scrollto " href="DoctorHome.jsp">Home</a></li>
          ...
          <li><a class="nav-link scrollto" href="ViewUploadReports.jsp">PATIENT UPLOADED REPORT</a></li>
            <li><a class="nav-link scrollto" href="PConsultation.jsp">LIVE CHATTING</a></li>
  ...
  background-color: #dddddd;
    ...
    <!-- ======= Breadcrumbs Section ======= -->
        ...
        <div class="mx-5 md-mx-l5">
            ...
            <br><br><br>
             ...
             <form action="Compose1" method="post">
                <div>
                <label for="doctorname">PATIENTS :</label>
                        <select name="doctorname" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-black fw-300 fs-s3 mr-0 br-l-0">
		...
		%>
                    ...
                    class="input-lg half bw-0 fw-200 bg-indigo-lightest-10 black ph-indigo-lightest focus-black opacity-80 fs-s3 py-5 min-w-25vw br-r-0"
                    placeholder="Enter Patient Report" > </textarea>
                    <br><br>
                    <input type="submit" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-black fw-300 fs-s3 mr-0 br-l-0"
                         placeholder="Send"/>
                    </div>
                </form>
        </div>
