  ...
  background-color: #dddddd;
    ...
    <!-- ======= Breadcrumbs Section ======= -->
        ...
        <div class="mx-5 md-mx-l5">
            <div>
            <br><br><br><br><br>
<h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">PATIENTS APPOINMENT REQUEST</h1>
<br><br>
...
ResultSet al=Dao.getAllusers2(uid);%>
...
<tr style="color: black;">
	...
	<td><a href="ApproveByDoctor?email=<%=al.getString(2) %>">APPROVE</a></td>
