    ...
    <!-- ======= Breadcrumbs Section ======= -->
     <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            ...
            <br> <br> <br> <br> <br>
            <center>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">EMERGENCY ADMIN REGISTRATION</h1>
                </center>
				<form action="RelativeRegister" method="post">
                <div>
                  <label for="RelativeName">ED ADMIN NAME:</label>
                <input type="text"
                       
                        placeholder="Enter Admin Name" name="RelativeName"> &nbsp;&nbsp;&nbsp;
                        <br><br>
                          <label for="RelativeID">ED ADMIN ID OR MAIL ID:</label>
                    <input type="text"
                       
                        placeholder="Enter Admin ID" name="RelativeID"> 
                        <br><br>
                         <label for="RelativePassword">ED ADMIN PASSWORD:</label>
                        <input type="password"
                       
                        placeholder="Enter Password" name="RelativePassword" oninput="validatePasswordStrength(this)"> &nbsp;&nbsp;&nbsp;
						<span id="passwordStrengthIcon" class="password-strength-icon"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                        <br><br>
                        <label for="RelativeMobile">ED ADMIN MOBILE:</label>
                        <input type="text"
                       
                        placeholder="Enter Admin Contact No" name="RelativeMobile" oninput="validateMobileNumber(this)">
                        <br><br>
                        <label for="RelativeCountry">ED ADMIN COUNTRY:</label>
                    <input type="text"
                        
                        placeholder="Enter Admin Country" name="RelativeCountry">&nbsp;&nbsp;&nbsp;
						<br><br>
						 <label for="RelativeCity">ED ADMIN CITY:</label>
                        <input type="text"
                       
                        placeholder="Enter Admin City" name="RelativeCity">
						<br><br>
						 <label for="RelativeAddress">ED ADMIN ADDRESS:</label>
                        <input type="text"
                       
                        placeholder="Enter Admin Address" name="RelativeAddress"> &nbsp;&nbsp;&nbsp;
                        <br><br>
                    <input type="submit" 
