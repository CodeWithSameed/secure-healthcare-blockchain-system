  ...
  background-color: #dddddd;
    ...
    <!-- ======= Breadcrumbs Section ======= -->
       ...
       <section id="home" class="min-h-100vh flex justify-start items-center">
        ...
        String sql = "select pid from compose1 where did='"+name+"'";
        String pid = Dao.getName1(sql);
		System.out.println("hhh"+pid);
		String sql2= "select * from compose1 where did='"+name+"' and pid='"+pid+"'";
		List<String> lt = Dao.getPMessages(sql2);
		Iterator<String> itr = lt.iterator();
 		%>
				...
				while(itr.hasNext()){
				%>
				<tr style="color: black;"><td><a href="Compose2.jsp"><%=itr.next() %></a></td><td><%=itr.next() %></td><td><%=itr.next() %></td><td><%=itr.next() %></td>
				<%} %>
				</table>
				
			<!-- 	 <a href="Inbox2.jsp" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">View Inbox</a>
