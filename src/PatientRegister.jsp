...
<%@ page import="com.servlets.IDGenerator" %>

<%-- <%@ page import="your.package.path.to.generateRandomID" %> --%>
<%@ page language="java" %>
...
<body>
 ...
 <script>
    function validateForm() {
        var password = document.getElementsByName("PatientPassword")[0].value;
        var confirmPassword = document.getElementsByName("PatientCPassword")[0].value;
    ...
    <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
            ...
            <center>
				...
				<form action="PateintRegister" method="post" onsubmit="return validateForm()">
                <div>
                ...
                <input type="text"
                    ...
                    <input type="text"
                        ...
                        placeholder="Enter Patient ID" name="PatientID" value="<%= IDGenerator.generateRandomID(6) %>"> 
                        <br><br>
                         <label for="PatientPassword">PASSWORD :</label>
                        <input type="password"
                       
                        placeholder="Enter Password" name="PatientPassword" oninput="validatePasswordStrength(this)"> &nbsp;&nbsp;&nbsp;
						<span id="passwordStrengthIcon" class="password-strength-icon"></span>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                        <br><br>
                         <label for="PatientCPassword">CONFIRM PASSWORD :</label>
                        <input type="password"
                        ...
                        placeholder="Enter Patient Contact" name="PatientMobile" oninput="validateMobileNumber(this)">
                        <br><br>
                        <label for="PatientCountry">PATIENT COUNTRY:</label>
                    <input type="text"
                        ...
                        placeholder="Enter Patient Pincode" name="PatientPincode" oninput="validatePincode(this)"> 
                        <br><br>
                         <label for="vm">SELECT DOCTOR :</label>
                        <select name="vm" 
		...
		%>
                    ...
                    <input type="submit" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0"
                         ...
                         <input type="reset" class="button-lg bg-indigo-lightest-20 indigo-lightest focus-red fw-300 fs-s3 mr-0 br-l-0"
                         placeholder="Reset"/>
                                                 </div>
                </form>
        </div>
